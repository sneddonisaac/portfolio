...
export default function MainCTA() {
    return (
        <div id="Footer">
            <NoiseBG
                classNames="py-20 flex justify-center items-center text-white"
                gradient="light-gradient-bg-reverse"
            >
                <div className="z-10 flex w-full flex-col items-center justify-center sm:w-2/3 sm:flex-row sm:justify-evenly">
